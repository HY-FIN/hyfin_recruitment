...
export async function POST(req: NextRequest) {
  try {
    ...
    const {
      ...
      studentId, grade, major, gpa, subMajor, graduationPlan, enrollmentStatus,
      careers,
      essay1, essay2, essay3, essay4, essay5,
    } = body;

    const required = { name, phone, birthDate, email, gender, militaryStatus, studentId, grade, major, gpa, enrollmentStatus, essay1, essay2, essay3, essay4, essay5 };
